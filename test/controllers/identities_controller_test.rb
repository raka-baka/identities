...
class IdentitiesControllerTest < ActionController::TestCase
  ...
  test "should create identity" do
    assert_difference('Identity.count') do
      post :create, identity: { Address: @identity.Address, DOB: @identity.DOB, Email: @identity.Email, Name: @identity.Name }
    end
  ...
  test "should update identity" do
    patch :update, id: @identity, identity: { Address: @identity.Address, DOB: @identity.DOB, Email: @identity.Email, Name: @identity.Name }
    assert_redirected_to identity_path(assigns(:identity))
  end
